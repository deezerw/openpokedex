...
STORY_AREAS = [
    ...
    # ── Part 2: Viridian City & Route 22 ─────────────────────────────────────
    {
        "label": "Route 22",
        "locations": ["Route 22"],
        "notes": "LeafGreen gets Slowpoke here; FireRed gets Psyduck. Worth visiting early for Mankey and Nidoran.",
    },
    ...
    },
    {
        "label": "Route 4",
        "locations": ["Route 4"],
        "notes": "LeafGreen gets Sandshrew and Slowpoke here; FireRed gets Ekans and Psyduck.",
    },
    # ── Part 5: Cerulean City & Routes 24–25 ─────────────────────────────────
    {
        "label": "Route 24 & Route 25",
        "locations": ["Route 24", "Route 25"],
        "notes": "LeafGreen gets Bellsprout and Slowpoke here; FireRed gets Oddish and Psyduck.",
    },
    {
    ...
    # ── Part 8: Route 7–8, Lavender Town ─────────────────────────────────────
    {
        ...
        "notes": "LeafGreen gets Vulpix and Sandshrew here; FireRed gets Growlithe and Ekans.",
    },
    {
        "label": "Pokémon Tower",
    ...
    },
    {
        ...
        "notes": "Two Snorlax block Routes 12 and 16 — both require the Poké Flute to wake. LeafGreen gets Bellsprout/Weepinbell/Slowpoke here; FireRed gets Oddish/Gloom/Psyduck.",
    },
    ...
    # ── Part 13: Safari Zone ──────────────────────────────────────────────────
    {
        ...
        "notes": "LeafGreen gets Pinsir, Nidoran♀, and Slowpoke in the Safari Zone; FireRed gets Scyther, Nidoran♂, and Psyduck. Both have Kangaskhan, Tauros, Chansey, and Dratini.",
    },
    # ── Part 14: Fuchsia City → Routes 19–21 ─────────────────────────────────
    {
        "label": "Routes 19–21",
        "locations": ["Route 19", "Route 20", "Route 21", "Route 21 (in-game trade)"],
        "notes": "Trade a Clefairy for Mr. Mime on Route 21. LeafGreen gets Slowpoke/Kingler here; FireRed gets Psyduck/Seadra.",
    },
    {
    ...
    # ── Part 16: Pokémon Mansion & Cinnabar Lab Fossils ──────────────────────
    {
        ...
        "notes": "LeafGreen gets Vulpix and Muk here; FireRed gets Growlithe and Weezing.",
    },
    {
    ...
    },
    {
        "label": "Route 23",
        "locations": ["Route 23"],
        "notes": "LeafGreen gets Sandshrew/Sandslash/Slowpoke here; FireRed gets Ekans/Arbok/Psyduck.",
    },
    {
        "label": "Victory Road",
        "locations": ["Victory Road"],
        "notes": "LeafGreen gets Sandslash here; FireRed gets Arbok.",
    },
    # ── Sevii Islands (after 7th gym, during/after main story) ───────────────
    {
        "label": "One Island & Kindle Road",
        "locations": ["One Island", "Kindle Road"],
        "notes": "Accessible after defeating Blaine (7th gym) when Bill takes you to One Island. LeafGreen gets Slowpoke/Krabby/Kingler here; FireRed gets Psyduck/Horsea/Seadra.",
    },
    {
        "label": "Mt. Ember",
        "locations": ["Mt. Ember", "Mt. Ember, Sevii Island 1 (static)"],
        "notes": "Moltres is at the summit. LeafGreen gets Magmar here; FireRed gets Electabuzz.",
    },
    {
    ...
    # ── Post-game (after becoming Champion) ──────────────────────────────────
    {
        ...
        "notes": "Unlocked after becoming Champion. Mewtwo is the deepest static encounter. LeafGreen gets Slowpoke/Slowbro here; FireRed gets Psyduck/Golduck.",
    },
    {
        "label": "Four Island",
        "locations": ["Four Island"],
        "notes": "LeafGreen gets Slowpoke and Marill here; FireRed gets Psyduck and Wooper.",
    },
    {
        "label": "Five Island & Water Path",
        "locations": ["Five Island", "Water Path"],
        "notes": "LeafGreen gets Slowpoke/Krabby/Kingler/Staryu/Remoraid here; FireRed gets Psyduck/Shellder/Horsea/Seadra/Qwilfish.",
    },
    {
        "label": "Icefall Cave (Four Island area)",
        "locations": ["Icefall Cave"],
        "notes": "LeafGreen gets Slowpoke, Krabby, Kingler, Staryu, Marill, and Sneasel here; FireRed gets Psyduck, Shellder, Horsea, Seadra, Wooper, and Delibird.",
    },
    {
        "label": "Altering Cave",
    ...
    },
    {
        ...
        "notes": "LeafGreen gets Bellsprout/Weepinbell/Slowpoke/Slowbro here; FireRed gets Oddish/Gloom/Psyduck/Golduck.",
    },
    {
        "label": "Lost Cave (Five Island)",
        "locations": ["Lost Cave"],
        "notes": "LeafGreen gets Misdreavus here; FireRed gets Murkrow.",
    },
    {
    ...
    {
        "label": "Sevault Canyon (Seven Island)",
        "locations": ["Sevault Canyon"],
        "notes": "Contains rare Pokémon: Larvitar and Phanpy. FireRed also gets Skarmory here. Requires HM Rock Smash and Strength.",
    },
    {
    ...
    },
    {
        ...
        "notes": "Unlock by solving the Tanoby Key in Tanoby Chambers. Different Unown letters in each ruin room. LeafGreen gets Krabby/Kingler/Remoraid/Mantine here; FireRed gets Psyduck/Horsea/Seadra/Qwilfish.",
    },
    {
