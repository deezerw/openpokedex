...
STORY_AREAS = [
    ...
    # ── Part 3: Route 102, Route 104 & Petalburg Woods ───────────────────────
    {
        "label": "Route 102",
        "locations": ["Route 102"],
        "notes": "Ruby gets Seedot here; Sapphire gets Lotad.",
    },
    {
    ...
    },
    {
        ...
        "notes": "Ruby gets Mawile here; Sapphire gets Sableye.",
    },
    ...
    },
    {
        "label": "Route 114",
        "locations": ["Route 114"],
        "notes": "Ruby gets Zangoose here; Sapphire gets Seviper.",
    },
    {
        "label": "Meteor Falls",
        "locations": ["Meteor Falls"],
        "notes": "Bagon is in the back room and requires Surf. Ruby gets Solrock; Sapphire gets Lunatone.",
    },
    ...
    },
    {
        ...
        "notes": "Ruby gets Duskull on Routes 121/123; Sapphire gets Shuppet.",
    },
    # ── Part 11: Safari Zone ──────────────────────────────────────────────────
    {
        "label": "Safari Zone",
    ...
    # ── Part 13: Route 124, Seafloor Cavern, Cave of Origin ──────────────────
    {
        "label": "Route 124",
        "locations": ["Route 124"],
    },
    ...
    {
        "label": "Cave of Origin — Groudon (Ruby) / Kyogre (Sapphire)",
        "locations": ["Cave of Origin", "Cave of Origin (static)"],
        "notes": "Groudon is the static encounter in Ruby; Kyogre in Sapphire. Ruby gets Mawile in the wild encounters; Sapphire gets Sableye.",
    },
    {
    ...
    },
    {
        ...
        "notes": "Rayquaza is at the summit. Ruby gets Mawile and Dusclops here; Sapphire gets Sableye and Banette.",
    },
    {
        "label": "Regi Trio",
    ...
    {
        "label": "Southern Island — Latios",
        "locations": ["Southern Island (static)", "Southern Island (Eon Ticket event)"],
        "notes": "Ruby: Latios is the static encounter on Southern Island. Latias requires the Eon Ticket event to encounter on Southern Island (or can be found roaming post-game).",
    },
    {
        "label": "Roaming Hoenn — Latias",
        "locations": ["Roaming Hoenn (post-game)"],
        "notes": "Latias roams Hoenn in Ruby after becoming Champion.",
    },
    {
        "label": "Event Pokémon",
        "locations": [
        ...
        "notes": "Jirachi via Pokémon Colosseum Bonus Disc (NA/AU) or Pokémon Channel (PAL). Celebi (Ruby only) was Japan-only via Nintendo event.",
    },
]
